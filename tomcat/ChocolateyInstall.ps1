...
$packageName = 'Tomcat' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these: exe, msi, msu
$url = 'http://archive.apache.org/dist/tomcat/tomcat-6/v6.0.29/bin/apache-tomcat-6.0.29.exe' # download url
$url64 = 'http://archive.apache.org/dist/tomcat/tomcat-6/v6.0.29/bin/' # 64bit URL here or remove - if installer decides, then use $url
